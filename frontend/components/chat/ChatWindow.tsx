      ...
      {messages.map((msg) => (
        ...
        >
          ...
          <div className={`prose prose-sm max-w-none ${
            msg.role === "user" 
              ? "bg-slate-100 px-5 py-3 rounded-2xl rounded-tr-sm text-slate-900" 
              : "text-slate-800"
          }`}>
          ...
          {msg.role === "user" && (
            <div className="w-8 h-8 rounded-full bg-slate-200 flex-shrink-0 flex items-center justify-center border border-slate-300">
